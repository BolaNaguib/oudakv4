...
<section class="uk-section">
    <div class="uk-container uk-container-large">
        ...
        <hr>
        <form class="uk-form-horizontal" action="{{ route('storeuserinfo') }}" method="post">
          @csrf
                        ...
                        <div class="" uk-grid>
                          ...
                          <div class="uk-width-1-1">
                              ...
                              <div class="uk-margin">
                                  ...
                                  <!-- START .uk-form-controls -->
                                  <div class="uk-form-controls">
                                      <input class="input uk-width-expand" id="form-stacked-text" name="firstname" type="text" required="" name="firstname" placeholder="Jhon">
                                  </div><!-- END .uk-form-controls -->
                              </div><!-- END .uk-margin -->
                          </div><!-- END uk-width-1-1 -->
                          <!-- START .uk-width-1-1 -->
                          <div class="uk-width-1-1">
                              ...
                              <div class="uk-margin">
                                  ...
                                  <!-- START .uk-form-controls -->
                                  <div class="uk-form-controls">
                                      <input class="input uk-width-expand" id="form-stacked-text" name="lastname" type="text" required="" placeholder="Doe">
                                  </div><!-- END .uk-form-controls -->
                              </div><!-- END .uk-margin -->
                          </div><!-- END uk-width-1-1 -->
                          <!-- START .uk-width-1-1 -->
                          <div class="uk-width-1-1">
                              ...
                              <div class="uk-margin " id="locationField">
                                  ...
                                  <!-- START .uk-form-controls -->
                                  <div class="uk-form-controls">
                                      <input class="input uk-width-expand" id="autocomplete"  name="address" type="text" required="" placeholder="243 naser st">
                                  </div><!-- END .uk-form-controls -->
                              </div><!-- END .uk-margin -->
                          </div><!-- END uk-width-1-1 -->
                          ...
                          <div class="uk-width-1-2">
                              ...
                              <div class="uk-margin">
                                  ...
                                  <!-- START .uk-form-controls -->
                                  <div class="uk-form-controls">
                                      <input class="input uk-width-expand" id="form-stacked-text" name="zipcode" type="text" required="" placeholder="Jhon">
                                  </div><!-- END .uk-form-controls -->
                              </div><!-- END .uk-margin -->
                          </div><!-- END uk-width-1-1 -->
                          ...
                          <div class="uk-width-1-2">
                              ...
                              <div class="uk-margin">
                                  ...
                                  <!-- START .uk-form-controls -->
                                  <div class="uk-form-controls">
                                      <input class="input uk-width-expand" id="form-stacked-text" name="city" type="text" required="" placeholder="Jhon">
                                  </div><!-- END .uk-form-controls -->
                              </div><!-- END .uk-margin -->
                          </div><!-- END uk-width-1-1 -->
                          ...
                          <div class="uk-width-1-2">
                              ...
                              <div class="uk-margin">
                                  ...
                                  <!-- START .uk-form-controls -->
                                  <div class="uk-form-controls">
                                      <input class="input uk-width-expand" id="form-stacked-text" name="state" type="text" required="" placeholder="Jhon">
                                  </div><!-- END .uk-form-controls -->
                              </div><!-- END .uk-margin -->
                          </div><!-- END uk-width-1-1 -->
                          ...
                          <div class="uk-width-1-2">
                              ...
                              <div class="uk-margin">
                                  ...
                                  <!-- START .uk-form-controls -->
                                  <div class="uk-form-controls">
                                      <input class="input uk-width-expand" id="form-stacked-text" name="country" type="text" required="" placeholder="Jhon">
                                  </div><!-- END .uk-form-controls -->
                              </div><!-- END .uk-margin -->
                          </div><!-- END uk-width-1-1 -->
                          ...
                          <div class="uk-width-1-1">
                              ...
                              <div class="uk-margin">
                                  ...
                                  <!-- START .uk-form-controls -->
                                  <div class="uk-form-controls">
                                      <input class="input uk-width-expand" id="form-stacked-text" name="nearlocation" type="text" required="" placeholder="Jhon">
                                  </div><!-- END .uk-form-controls -->
                              </div><!-- END .uk-margin -->
                          </div><!-- END uk-width-1-1 -->
                        </div>
