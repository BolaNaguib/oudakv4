    ...
    <div class="uk-grid-match" uk-grid>
      ...
      <div class="uk-width-1-3@m uk-width-1-2">
        ...
        <div class="card card_theme_white uk-position-relative uk-transition-toggle uk-zindex" tabindex="0">
          ...
          {{-- START $productcategory->Productone->wishlist->isEmpty() --}}
          ...
          {{-- else $productcategory->Productone->wishlist->isEmpty() --}}
          @else
          <div class="uk-position-small uk-position-top-right">
            <form action="{{route('wishlist.destroy', $productcategory->Productone->wishlist[0]->id)}}"
          ...
          @endif
          {{-- END $productcategory->Productone->wishlist->isEmpty() --}}
          ...
          {{-- START if $item == $productcategory->Productone->id --}}
          @if ($item == $productcategory->Productone->id)
          ...
          {{-- ELSE if $item == $productcategory->Productone->id --}}
          @else
          ...
          @endif
          {{-- END if $item == $productcategory->Productone->id --}}
          @endforeach
            ...
            <div class="uk-flex uk-flex-middle uk-flex-center uk-position-relative uk-transition-toggle" tabindex="0">
              ...
              <a href="{{ route('shop.show', $productcategory->Productone->slug)}}">
                ...
                <div class="uk-inline-clip uk-transition-toggle" tabindex="0">
                  <img src="{{ asset('storage/'.$productcategory->Productone->thumbnail) }}" alt=""
                    style="max-height:350px;">
                  <img class="uk-transition-fade uk-position-cover"
                    src="{{ asset('storage/'.$productcategory->Productone->secondimage) }}" alt=""
