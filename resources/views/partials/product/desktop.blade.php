            ...
            @foreach($errors->all() as $error)
                ...
                <div class="uk-width-1-2@m uk-width-1-1">
                    ...
                    <div id="productzoom" class="card card_theme_white uk-flex uk-flex-middle uk-flex-center uk-position-relative uk-transition-toggle uk-zindex" tabindex="0">
                        ...
                        <a class="uk-button uk-button-default ingredientButton" style="position: absolute;bottom: 5px;z-index: 99">Ingredients</a>
                        <style media="screen">
                          .ingredientboxalter{
                            position: absolute;z-index: 9;left: 0px;top: 0px;width: 100%;height: 100%;background-color: rgba(245, 245, 245, 0.65);display: none;transition: 500ms;
                          }
                        </style>
                        <div class="uk-card uk-card-default uk-padding-small ingredientBox ingredientboxalter">
                            <div class="">
                                {!! $product->Ingredients !!}
                            </div>
                        </div>
                                    ...
                                    @for ($i=0; $i < count($product_slider); $i++) {{ $product_slider[''.$i.''] }} <li>
                                        <div class="uk-text-center">
                                            ...
                                            <a class="uk-inline" href="{{ asset('storage/'.$product_slider[''.$i.'']) }}">
                                                <img class="uk-visible@l" src="{{ asset('storage/'.$product_slider[''.$i.'']) }}" alt="" style="max-height: 400px;">
                                                <img class="uk-hidden@l" src="{{ asset('storage/'.$product_slider[''.$i.'']) }}" alt="" style="max-height: 250px;">
                                            </a>
                                        </div>
                        ...
                        <div class="uk-text-center">
                            ...
                            <div class=" uk-margin">
                                ...
                                <div class="uk-grid uk-flex-center">
                                    @for ($i=1; $i < 7; $i++) {{-- START uk-width-auto --}} <div class="uk-width-auto@m uk-width-1-1 {{ ${'product'}->{'price_' . $i} === null ? "uk-hidden" : "" }}">
                                        {{-- START .uk-position-relative --}}
                                        <div class="uk-position-relative">
                                            <input type="radio" name="pricex" class="newpricebutton" value="{{ ${'product'}->{'price_' . $i} }}" style=" width: 100%;height: 100%; left: 0%; z-index:999999999999999;" checked>
